...
var ep_map = make(map[string][]string)
var version = 1
...
func main() {
	...
	// create watcher
	epWatcher := cache.NewListWatchFromClient(clientset.CoreV1().RESTClient(), "endpoints", v1.NamespaceDefault, fields.Everything())
